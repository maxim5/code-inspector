  ...
  module Algorithm 
    ...
    class Fminer 
      ...
      def self.create_feature_dataset(params)
        ...
        resource.post(:dataset_uri => params[:dataset_uri], :feature_uri => params[:feature_uri], :token_id => params[:token_id])
      end
    ...
    class Lazar 
        ...
        @uri = resource.post(:dataset_uri => params[:dataset_uri], :token_id  => params[:token_id], :prediction_feature => params[:prediction_feature], :feature_generation_uri => File.join(@@config[:services]["opentox-algorithm"], "fminer")).body.chomp

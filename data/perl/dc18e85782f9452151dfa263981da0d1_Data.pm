...
sub new
{
  ...
  my $errStr = "Payroll::XML::Data->new()  - Error:";
...
sub generateXML
{
  my $self = shift;
  my $result = "";
  my $errStr = "Payroll::XML::Data->generateXML()  - Error:";
...
Data - The XML Payroll Data Module.

=head1 SYNOPSIS

  use Payroll::XML::Data;
  my $obj = Payroll::XML::Data->new(validCountries => \%validCountries,
            periodNames => \%periodNames);

=head1 DESCRIPTION

Payroll::XML::Data will contain the parsed XML file.
...
=head1 FUNCTIONS
  ...
  scalar new(validCountries, periodNames)
    Creates a new instance of the Payroll::XML::Data
    object.
  ...
  string generateXML(void)
    ...
    Payroll::XML::Data object.  It first calls isValid() to make sure

...
Partial Class Usercontrols_Reports_MostComments
...
#Region " Page Events "
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.Page.IsPostBack = False Then
            ...
            Me.uxMostCommentsItemsLabel.Text = ReportTitle

            With Me.uxMostCommentsRepeater
                .DataSource = List.GetTopNItemsMostComments(ReportDisplayCount, ReportType)
                .DataBind()
            End With
        End If
    End Sub
...
#Region " Form Controls Events "
    ...
    Protected Sub uxMostCommentsRepeater_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles uxMostCommentsRepeater.ItemDataBound

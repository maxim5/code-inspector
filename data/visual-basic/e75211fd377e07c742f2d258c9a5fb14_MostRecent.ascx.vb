...
Partial Class Usercontrols_Reports_MostRecent
...
#Region " Page Events "
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.Page.IsPostBack = False Then
			...
			Me.uxMostRecentItemsLabel.Text = ReportTitle

            With Me.uxMostRecentRepeater
                .DataSource = List.GetTopNItemsByType(ReportDisplayCount, ReportType)
                .DataBind()
            End With
        End If
    End Sub
...
#Region " Form Controls Events "
    ...
    Protected Sub uxMostRecentRepeater_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles uxMostRecentRepeater.ItemDataBound

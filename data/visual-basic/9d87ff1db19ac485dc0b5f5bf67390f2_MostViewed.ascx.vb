...
Partial Class Usercontrols_Reports_MostViewed
...
#Region " Page Events "
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.Page.IsPostBack = False Then
            ...
            Me.uxMostViewedItemsLabel.Text = ReportTitle

            With Me.uxMostViewedRepeater
                .DataSource = List.GetTopNItemsMostViewed(ReportDisplayCount, ReportType)
                .DataBind()
            End With
        End If
    End Sub
...
#Region " Form Controls Events "
    ...
    Protected Sub uxMostViewedRepeater_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles uxMostViewedRepeater.ItemDataBound

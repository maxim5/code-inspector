...
scale = 2;
initNum = 40;       % Original number of points picked
hillClimbingStart = 40;
incNum = 10;     % How many each time when picking uncertain points
maxRuns = 46;
...
for ii = 1:runs,
    ...
    elseif strcmpi(uncertMeasure,'entropy'),
        ...
        % TEST: replace bad numbers by inf for uncertainty check
        % tmpLog(isinf(tmpLog)) = 1e10;
        tmpLog(isinf(tmpLog)) = 0;    % orig

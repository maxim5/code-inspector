...
NICK = "lircbot"       -- default nick
USERNAME = "LircBot"   -- default username
REALNAME = "LircBot"   -- default realname
...
function handlers.on_err_nicknameinuse(_, nick)
    send("NICK", "_" .. nick)
    callback("nick_change", "_" .. nick, nick)
end
-- }}}
